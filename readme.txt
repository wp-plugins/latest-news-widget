...
*	Very easy to setup. __Requires NO technical knowledge__ to install
*	Can be translated to multiple languages
*	Outputs __clean, validated code__
...
You can find more information about this plugin at http://www.taylorlovett.com/wordpress-plugins

== Configuring and Using the Plugin ==
Instructions for this plugin can be found at http://www.taylorlovett.com/wordpress-plugins
...
== Upgrade Notice ==
For questions, feature requests, updates, and support concerning the Latest News Widget plugin, please visit:
http://www.taylorlovett.com/wordpress-plugins
